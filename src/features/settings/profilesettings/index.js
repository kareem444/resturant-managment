...
function ProfileSettings() {
    const { switchLang, isArabic, translate } = useLang()
    ...
    const updateFormValue = ({ updateType, value }) => {
        switchLang(isArabic ? langOptions[0].code : langOptions[1].code);
        console.log(updateType, value, isArabic)
    }
        ...
        <>
            ...
            <TitleCard title="Profile Settings" topMargin="mt-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <ToogleInput updateType="syncData" labelTitle={translate('language')} defaultValue={isArabic} updateFormValue={updateFormValue} />
                </div>
