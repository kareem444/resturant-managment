...
export default function AuthContainer(props: {
    ...
    return (
        <>
            ...
            <form onSubmit={props.handelSubmit ? props.handelSubmit(handelSubmit) : (e) => handelSubmitWithOutValidation(e)}>
                <div className='mb-4'>
                    {props.children}
                </div>
                ...
                <button
                    type='submit'
                    className={'btn mt-5 w-full btn-primary' + (loading ? ' loading' : '')}
                >
